...
class InstitutionaRepository implements InstitutionaInterface
{
    private $model, $commons;

    public function __construct(Institutiona $model, _ControlCommon $commons) {
        $this->model = $model;
	...
	public function index()
	{
		...
		$fieldsToSelect = $this->commons->fieldsToSelect('id,uuid,mission,vision,values');
		...
		if(isset($_GET['q'])){
			$fieldsToSearch = isset($_GET['q']) ? $this->commons->keywordsToSearch('vision,values') : '';
